...
The sample number is 2,  the mean is 51.92, which is close to 50, and the standard deviation is 41.8 and it's close to 42. The higher the sample number the smaller the standard deviation.
...
The number sample is 4, mean is 50.71, which is close to 50. The standard deviation is 20.92, which close to 21.
...
The number sample is 9, mean is 49.36,which is close to 50, and the standard deviation is 13.6, which close to 14.  
...
The number sample is 16, mean is 49.25,which is close to 50 and the standard deviation is 10.7, and it is close to 10.5.
...
The number sample is 25, mean is 49.58, which is close to 50. The standard deviation is 8.42 which is close to 8.4.
...
```
The number sample is 36, mean is 50.02, which is close to 50. The standard deviation is 6.92, which is close to 7. When the sample number increases, the smaller the standard deviation of the mean becomes.
